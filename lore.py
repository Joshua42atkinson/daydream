# /home/user/daydream_project/lore.py
# lore.py - Stores worldbuilding information for Daydream

# Using the finalized Race/Class/Philosophy lists from character.py
# Focus: Dumpster Planet, The Great Recycler, Thetopia
...
thetopia_lore = {
    ...
    "main_ai_entity": {
        ...
        "goals": ["Identify potential in wasted ideas", "Stabilize conceptual fragments", "Elevate ideas from 'trash' to 'treasure'", "Maintain balance on Dumpster Planet", "Observe emergent entities"]
    },
    ...
    "setting": {
        ...
        "main_hub": "Thetopia",
        # <<< ADDED THIS ENTRY based on your request >>>
    ...
    "locations": {
        ...
        "Thetopia - Town Square": {
            ...
            "present_npcs": ["Guard Captain Elena", "Info-Broker Pip"], # Example NPCs
            "exits": {"north": "Thetopia - Maker's Alley", "east": "Thetopia - Bakery Street", "west": "Thetopia - Library Steps", "south": "Thetopia - Residential Loop"} # Expanded exits example
        },
        "Thetopia - Whispering Willow Plaza": { # Keeping existing name for now, maybe rename?
            ...
            "present_npcs": ["Old Scholar Thistlewick"], # Example NPC
            "exits": {"east": "Thetopia - Bakery Street", "west": "Thetopia - Library Steps"}
        },
        "Thetopia - Bakery Street": {
            ...
            "present_npcs": ["Dottie Doughnut"], # Example NPC
            "exits": {"west": "Thetopia - Whispering Willow Plaza", "east": "Thetopia - Town Square"}
        },
        "Thetopia - Library Steps": {
            ...
            "present_npcs": [],
            "exits": {"east": "Thetopia - Whispering Willow Plaza", "up": "Thetopia - Library Interior"}
        },
        "Thetopia - Library Interior": {
            ...
            "present_npcs": ["Professor Quill"], # Example NPC
            "exits": {"down": "Thetopia - Library Steps"}
        },
         "Thetopia - Maker's Alley": { # New example location
            ...
            "present_npcs": ["Widget"], # Example NPC
            "exits": {"south": "Thetopia - Town Square"}
        },
         "Thetopia - Residential Loop": { # New example location
            ...
            "present_npcs": [],
            "exits": {"north": "Thetopia - Town Square"}
        },
        # --- Dumpster Planet Zones (Examples) ---
        "Shifting Glitch Fields": {
            ...
            "present_npcs": [],
            "exits": {"towards thetopia": "Thetopia - Town Square"} # Example exit
        },
    ...
    "classes": {
        ...
        "Inventor": {
            ...
            "notes_for_interactions": "Creative, analytical, often focused on projects, value utility and ingenuity, sometimes prone to 'Eureka!' moments or minor explosions."
        },
        "Archanist": {
    ...
    "philosophies": {
        ...
        "Pointlessnesses": {
         ...
         # Add other philosophies if needed based on character.py data
    },

    "npcs": {
        # Example NPCs fitting the theme
        "Guard Captain Elena": {
            "name": "Guard Captain Elena", # Full name for potential display
            ...
            "personality": ["dutiful", "by-the-book", "observant", "weary", "prefers efficiency"],
            "knowledge": ["Thetopia security protocols", "known safe zones nearby", "common chaotic incursions", "location of key facilities"],
            "dialogue_hooks": {"greeting": ["State your purpose.", "Keep the pathways clear.", "Report anything unusual immediately."]}
        },
        "Old Scholar Thistlewick": {
             ...
             "personality": ["patient", "scholarly", "slow-speaking", "fascinated by origins", "slightly forgetful"],
             "knowledge": ["Thetopia history fragments", "theories on The Great Recycler", "nature of conceptual energy", "locations of rare data nodes"],
             "dialogue_hooks": {"greeting": ["Hmm? Another spark seeking knowledge?", "The patterns... always shifting...", "Have you seen any interesting conceptual residue lately?"]}
        },
         "Widget": {
             "name": "Widget",
             ...
             "personality": ["energetic", "easily distracted", "brilliant but disorganized", "loves bartering", "speaks quickly"],
             "knowledge": ["salvage locations", "basic gadget repair/crafting", "who needs what part", "rumors from the scrap heaps"],
             "dialogue_hooks": {"greeting": ["Need something fixed? Got parts? Shiny parts? Let's make a deal!", "Careful where you step! That's my prototype dream-catcher!", "Quick quick, what is it? Ideas to build!"]}
        },
        # Add Professor Quill, Dottie Doughnut, Bongo etc. with thematic descriptions
         "Professor Quill": { # Example placeholder
             "name": "Professor Quill",
             "description": "The caretaker of Quill's Literary Repository.",
             "personality": ["knowledgeable", "slightly flustered"],
             "knowledge": ["books", "history", "magic theory"],
             "dialogue_hooks": {"greeting": ["Shh! Please keep your voice down."]}
         },
         "Dottie Doughnut": { # Example placeholder
             "name": "Dottie Doughnut",
             "description": "The cheerful Opossuman baker at 'Reclaimed Crust'.",
             "personality": ["friendly", "optimistic", "loves sharing food"],
             "knowledge": ["baking", "local gossip", "ingredient sources"],
             "dialogue_hooks": {"greeting": ["Welcome! Try a nutrient paste pastry!"]}
         },
         "Bongo": { # Example placeholder
             "name": "Bongo",
             "description": "A stressed Slime musician usually found near the plaza.",
             "personality": ["anxious", "melodic", "sensitive to noise"],
             "knowledge": ["music theory", "sound frequencies", "emotional resonance"],
             "dialogue_hooks": {"greeting": ["Wobble... the harmonies are all wrong today..."]}
         }
    }
}

# --- Function to potentially load/validate lore (Optional) ---
def get_lore():
    # In a real app, you might load from JSON/YAML here,
    # or validate the structure of the thetopia_lore dict.
